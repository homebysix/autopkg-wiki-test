...
def main(_):
    ...
    for processor_name in sorted(processor_names(), key=lambda s: s.lower()):
        ...
        output += "\n"
        output += "| NOTE |\n| :---: |\n| **This page is automatically generated by GitHub Actions when a new release is tagged.**<br /><br />Updates to the information on this page should be submitted in pull requests to the AutoPkg repository. Processors are located at Code/autopkglib. |"
        output += "\n"
